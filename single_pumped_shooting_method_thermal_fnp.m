%function single_pumped_shooting_method_thermal_fnp
clear all;
...
%----------高掺杂-----------
Ner=5.1e25;  %4e25; %%掺杂浓度Er  但是实际参与的粒子数可能没有那么多！！！
Nyb=7.6e26; %5e26;  %%掺杂浓度Yb (Nyb/Ner=14) the ratio of Nyb/Ner is approximately 4~20/8~30
...
Pdiss=(P56*1)*eta(1,u);% Pdiss is mainly produced by the quantum defect, which is the absorbed pump power minus the output signal power at both 1&1.5 μm
...
Sgm56(g,u)=0; %Attention！！！因为sgm56<<sgm65,则可以并且一定要令sgm56=0;否则会出现Ts2*(n6*sgm65-n5*sgm56)-alpha2 < 0的情况，则p(3,:)不增大反而减小！！！！ %Sgm56(g,u)=Sgm65(g,u)*Zf(6,2)/Zf(5,2)*exp((E(6,1)-E(5,1)-(E(6,1)-E(5,2)))*M(2)); 
