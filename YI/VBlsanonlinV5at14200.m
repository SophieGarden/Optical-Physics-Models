...
L1 = 32; % L+1 = length of the vector
L2 = 16;

                         x0 = [14200,297,291,0.536,0.531];

                                %x0 = [ 22065.8 229.325 221.452 0.738 0.657];


                                lb = [ 10000   170     170     0.1        0.1  ];
        ...
        if n == 0 
           m = 0;
                            ...
                            for deltaV1 = -1:-1:-nn; 
                                ...
                                [x,resnorm,residual,exitflag,output,lambda,jacobian] = lsqnonlin(@EPSV5at14200, x0, lb, ub);
